...
int main() {
    ...
    unsigned int groundDiffuseMap = loadTexture(FileSystem::getPath("resources/textures/albedo.jpg").c_str());
    unsigned int groundNormalMap  = loadTexture(FileSystem::getPath("resources/textures/normal.jpg").c_str());
    unsigned int groundHeightMap  = loadTexture(FileSystem::getPath("resources/textures/displacement.png").c_str());
